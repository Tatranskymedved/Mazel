...
namespace Mazel
{
	static GLenum ShaderDataTypeToOpenGLBaseType(ShaderDataType type)
	{
		...
		MZ_CORE_ASSERT(false, "ShaderDataTypeToOpenGLBaseType: Unknown ShaderDataType!");
		return 0;
	}
	...
	{
		MZ_CORE_ASSERT(vertexBuffer->GetLayout().GetElements().size(), "OpenGLVertexArray::AddVertexBuffer: Vertex Buffer has no layout!");
